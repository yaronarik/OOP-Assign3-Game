...
public class GameInit {
    ...
    private void addEnemies() {
        ...
        allEnemiesOptions.put('B',new Trap('B',"Bonus Enemies.Trap",1,1,1,250,1,5));
        allEnemiesOptions.put('Q',new Trap('Q',"Queen's Enemies.Trap",250,50,10,100,3,7));
        allEnemiesOptions.put('D',new Trap('D',"Death Enemies.Trap",500,100,2,250,1,10));
    }
