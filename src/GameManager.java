...
public class GameManager {
    ...
    public void run(String dir)
    {
        ...
        int playerNumber=userInterface.read();
        ...
        //        System.out.println(c);//@TODO delete this.
                switch (c) {
                    ...
                    case '@' :
                        ...
                        player.initialize(new Position(i,j),()-> this.playerDeath(),( message) -> userInterface.print(message),( t)-> board.swap(player,t),( x, y) -> board.getTileInPos(new Position(x,y) ),()-> scanner.next().charAt(0),(range)->getEnemiesInRange(player,range));
                        break;
